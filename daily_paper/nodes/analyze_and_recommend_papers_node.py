...
class AnalyzeAndRecommendPapersNode(Node):
    ...
    def __init__(self, recommendation_count: int = 3):
        """
        初始化节点
    ...
    def exec(self, prep_res):
        ...
        # 构建prompt
        prompt = self._build_analysis_prompt(papers_info, target_date, recommendation_count)
    ...
    def _build_analysis_prompt(self, papers_info: List[Dict], target_date, recommendation_count: int) -> str:
        """构建分析prompt"""
    ...
    def _parse_llm_response(self, response: str) -> Dict[str, Any]:
        ...
        try:
            ...
            for i, rec in enumerate(recommendations):
                rec_fields = ["paper_id", "title", "description", "reason", "highlights"]
